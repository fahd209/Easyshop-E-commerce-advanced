...
VALUES  ('Smartphone', 499.99, 1, 'A powerful and feature-rich smartphone for all your communication needs.', 'smartphone.jpg', 50, 0, 'Black'),
        ...
        ('Smart Watch', 199.99, 1, 'Stay connected and track your fitness goals with this stylish smartwatch.', 'smartwatch.jpg', 25, 0, 'White'),
        ...
        ('Fitness Tracker', 89.99, 1, 'Monitor your fitness activities and achieve your health goals with this fitness tracker.', 'fitness-tracker.jpg', 30, 0, 'Charcoal'),
        ...
        ('Gaming Keyboard', 79.99, 1, 'Enhance your gaming experience with this responsive and customizable gaming keyboard.', 'gaming-keyboard.jpg', 35, 0, 'Black'),
...
-- mens clothes
INSERT INTO products (name, price, category_id, description, image_url, stock, featured, color) 
VALUES  ('Men''s T-Shirt', 29.99, 2, 'A comfortable and stylish t-shirt for everyday wear.', 'mens-tshirt.jpg', 50, 0, 'Charcoal'),
        ...
        ('Men''s Polo Shirt', 39.99, 2, 'A classic and versatile polo shirt for a smart-casual style.', 'mens-polo-shirt.jpg', 50, 0, 'Olive'),
        ...
        ('Men''s Watch', 149.99, 2, 'A sophisticated and elegant watch to complete your look.', 'mens-watch.jpg', 20, 0, 'Black'),
        ...
        ('Men''s Casual Shirt', 39.99, 2, 'A versatile and comfortable shirt for a laid-back style.', 'mens-casual-shirt.jpg', 30, 0, 'Gray');
-- womens clothes
INSERT INTO products (name, price, category_id, description, image_url, stock, featured, color) 
VALUES  ('Women''s Dress', 79.99, 2, 'A beautiful and elegant dress for special occasions.', 'womens-dress.jpg', 50, 0, 'Mint'),
        ('Women''s Jeans', 69.99, 2, 'Comfortable and stylish jeans for a fashionable look.', 'womens-jeans.jpg', 30, 0, 'Blue'),
        ('Women''s Blouse', 49.99, 2, 'A versatile and chic blouse for everyday wear.', 'womens-blouse.jpg', 40, 0, 'Lavender'),
        ('Women''s Sweater', 59.99, 2, 'Stay cozy and fashionable with this stylish sweater.', 'womens-sweater.jpg', 25, 0, 'Teal'),
        ('Women''s Skirt', 39.99, 2, 'A trendy and versatile skirt for a feminine look.', 'womens-skirt.jpg', 10, 0, 'Gray'),
        ('Women''s Shorts', 34.99, 2, 'Comfortable and stylish shorts for a casual summer look.', 'womens-shorts.jpg', 30, 0, 'Blue'),
        ...
        ('Women''s Blazer', 89.99, 2, 'A sophisticated and tailored blazer for a polished look.', 'womens-blazer.jpg', 15, 0, 'Maroon'),
        ...
        ('Women''s Shoes', 79.99, 2, 'Step out in style with these fashionable and comfortable shoes.', 'womens-shoes.jpg', 35, 0, 'Red'),
        ('Women''s Hat', 29.99, 2, 'Add a stylish touch to your look with this fashionable hat.', 'womens-hat.jpg', 100, 0, 'Orange'),
        ...
        ('Women''s Formal Gown', 199.99, 2, 'A stunning and glamorous gown for formal events.', 'womens-gown.jpg', 30, 0, 'Burgundy');
-- home & kitchen
INSERT INTO products (name, price, category_id, description, image_url, stock, featured, color) 
VALUES  ('Cookware Set', 149.99, 3, 'A comprehensive set of high-quality cookware for all your culinary needs.', 'cookware-set.jpg', 50, 1, 'Red'),
        ...
        ('Kitchen Knife Set', 59.99, 3, 'A set of sharp and durable knives for effortless food preparation.', 'knife-set.jpg', 40, 0, 'Silver'),
        ...
        ('Blender', 49.99, 3, 'Blend smoothies, soups, and more with this powerful and reliable blender.', 'blender.jpg', 10, 0, 'Black'),
        ...
        ('Slow Cooker', 69.99, 3, 'Prepare flavorful and tender meals with this convenient slow cooker.', 'slow-cooker.jpg', 50, 0, 'Blue'),
        ...
        ('Utensil Set', 19.99, 3, 'A comprehensive set of cooking utensils for all your kitchen needs.', 'utensil-set.jpg', 35, 0, 'Silver'),
        ...
        ('Bakeware Set', 79.99, 3, 'A versatile set of baking pans and trays for all your baking needs.', 'bakeware-set.jpg', 10, 0, 'White'),
        ...
        ('Ice Cream Maker', 49.99, 3, 'Make delicious homemade ice cream with this easy-to-use ice cream maker.', 'ice-cream-maker.jpg', 25, 0, 'Black'),
        ...
        ('Spice Rack', 24.99, 3, 'Organize and display your spices with this convenient and space-saving spice rack.', 'spice-rack.jpg', 30, 0, 'White'),
        ...
        ('Tea Kettle', 29.99, 3, 'Brew a perfect cup of tea with this classic and durable tea kettle.', 'tea-kettle.jpg', 50, 0, 'White'),
        ('Wine Glasses', 29.99, 3, 'Sip and savor your favorite wines with these elegant wine glasses.', 'wine-glasses.jpg', 15, 0, 'Clear'),
        ...
        ('Mixing Bowls Set', 29.99, 3, 'A set of versatile and durable mixing bowls for all your culinary creations.', 'mixing-bowls.jpg', 30, 0, 'Silver'),
        ('Measuring Cup Set', 14.99, 3, 'Accurately measure ingredients with this set of handy and stackable measuring cups.', 'measuring-cups.jpg', 50, 0, 'Green');
